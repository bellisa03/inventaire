...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'date_out' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'FK_items_id_equipments' => ['type' => 'index', 'columns' => ['id_equipments'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_items_id_equipments' => ['type' => 'foreign', 'columns' => ['id_equipments'], 'references' => ['equipments', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
